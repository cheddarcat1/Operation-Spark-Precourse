...
const detectNetwork = (cardNumber) => {
    ...
    // Discover always has a prefix of 6011, 644-649, or 65, and a length of 16 or 19.
        ...
        (cardNumber.startsWith('6011') || (parseInt(cardNumber.substring(0, 3)) >= 644 && parseInt(cardNumber.substring(0, 3)) <= 649) || cardNumber.startsWith('65')) && (cardNumber.length === 16 || cardNumber.length === 19)) {
        return 'Discover';
    }
